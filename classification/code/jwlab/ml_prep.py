...
slicing_window_time_length = [300, 400, 500, 600]
...
def slicing_window(df, time_length):
    df_list = []
...
def prep_ml_internal(df, ys, participants, downsample_num=1000, averaging="average_trials"):
    ...
    # do slicing slicing_window
    for time_length in slicing_window_time_length:
        sw_list_for_all_time_length.append(slicing_window(df, time_length))
