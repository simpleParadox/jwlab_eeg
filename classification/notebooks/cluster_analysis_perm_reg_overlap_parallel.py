...
from jwlab.cluster_analysis_perm_parallel import cluster_analysis_procedure
...
# result = cluster_analysis_procedure(12, False, "average_trials_and_participants", [-200, 1000, [100], 10], [5, 4, 80], type='simple')
if __name__ == '__main__':
    print('Main function')
    result = cluster_analysis_procedure(9, True, "tgm", [-200, 1000, [100], 10], [5, 4, 1], type='permutation')
# In[25]:
