...
# result = cluster_analysis_procedure(9, False, "average_trials_and_participants", [-200, 1000, [100], 10], [5, 4, 10], type='simple')
...
result = cluster_analysis_procedure(9, False, "tgm", [-200, 1000, [100], 10], [5, 4, 4], type='simple')
