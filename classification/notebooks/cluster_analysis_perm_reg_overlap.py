...
result = cluster_analysis_procedure(12, False, "average_trials_and_participants", [-200, 1000, [100], 10], [5, 4, 50], type='simple', animacy=True, no_animacy_avg=False, do_eeg_pca=False, do_sliding_window=False)
