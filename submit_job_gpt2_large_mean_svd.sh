...
#SBATCH --job-name=2025_Mar_16_9m_gpt2-large-mean-9m-eeg_to_vectors_updated_ridge_params_fixed_seed_200_iters_range_0-200
#SBATCH --output=gpt2_large-mean_svd_16_12m_out_files/%x-%j.out
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=$SLURM_ARRAY_TASK_ID --age_group=9 --graph_file_name='2025_9m-gpt2-large-mean_to_vectors_fixed_seed_svd_-16_layer' \
       --model_name='gpt2-large-mean-svd-16' --iteration_range 0 200 --fixed_seed --svd_vectors
