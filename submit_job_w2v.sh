...
#SBATCH --job-name=2025_Mar_15_12m_w2v-12m-eeg_to_vectors_updated_ridge_params_fixed_seed_50_iters_range_150_200
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=1 --age_group=12 --graph_file_name='2025_mar_14_w2v-12m-eeg_to_vectors_fixed_seed_50_iters_range_150_200' \
       --embedding_type='w2v' --iteration_range 150 200 --fixed_seed
