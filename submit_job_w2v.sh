...
#SBATCH --job-name=2025_Mar_1_12m_w2v-12m-eeg_to_vectors_updated_ridge_params_fixed_seed
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=1 --age_group=12 --graph_file_name='2025_w2v-12m-w2v_to_vectors_fixed_seed' \
       --iterations=50 --fixed_seed
