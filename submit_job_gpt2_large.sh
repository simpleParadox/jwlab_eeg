...
#SBATCH --job-name=2025_Mar_1_12m_gpt2-large-12m-eeg_to_vectors_updated_ridge_params_fixed_seed
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=$SLURM_ARRAY_TASK_ID --age_group=12 --graph_file_name='2025_12m-gpt2-large_to_vectors_fixed_seed_layer' \
       --iterations=50 --fixed_seed --model_name='gpt2-large'
