...
#SBATCH --job-name=2025_Mar_1_9m_gpt2-large-9m-eeg_to_vectors_updated_ridge_params_layer_1
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=1 --age_group=9 --graph_file_name='gpt2-large-9m-eeg_to_vectors_layer_1' \
       --iterations=50 --model_name='gpt2-large'
