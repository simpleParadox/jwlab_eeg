...
#SBATCH --job-name=2025_Mar_15_across_w2v-9_to_12_eeg_to_vectors_updated_ridge_params_fixed_seed_50_iters_range_50_53
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=1 --age_group_range 9 12 --graph_file_name='test_2025_mar_17_w2v-across_eeg_to_vectors_fixed_seed_50_iters_range_50_53_' \
