...
#SBATCH --job-name=2025_Mar_18_12m_w2v-12m-eeg_to_vectors_updated_ridge_params_fixed_seed_50_iters_range_50_100
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=1 --age_group=12 --graph_file_name='2025_mar_18_12m_tgm_w2v_fixed_seed_50_iters_range_50_100' \
