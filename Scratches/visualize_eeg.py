...
def viz_eeg(participant):
    ...
    participant_path = f'/Users/simpleparadox/Desktop/Projects/jwlab_eeg/Data/Imported/cleaned2/{participant}_cleaned_ml.csv'
    ...
    # plt.show()
    plt.savefig(f"/Users/simpleparadox/PycharmProjects/jwlab_eeg/eeg_visuals/cleaned2/{participant}.png")
