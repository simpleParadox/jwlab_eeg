...
#SBATCH --job-name=test_2025_Mar_18_across_12_to_9m_w2v_updated_ridge_params_fixed_seed_50_iters_range_50_100
...
python classification/notebooks/cluster_analysis_perm_reg_overlap.py --seed=-1 \
       --layer=1 --age_group_range 12 9 --graph_file_name='2025_mar_18_12_to_9_across_tgm_w2v_fixed_seed_50_iters_range_50_100' \
...
# --model_name=None # this is for w2v embeddings is the default behaviour.
